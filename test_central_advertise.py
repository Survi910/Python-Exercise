...
class Central(BLEDriverObserver, BLEAdapterObserver):
    ...
    def on_gap_evt_adv_report(self, ble_driver, conn_handle, peer_addr, rssi, adv_type, adv_data):
        ...
        # f = open(Settings.current().test_output_directory+"/report.txt", "w")
        # f.write("Received advertisment report, address: 0x{}, device_name: {}".format(address_string,dev_name))
        logger.info(
...
class Scan(unittest.TestCase):
    def setUp(self):
        ...
        logger.info("I am validating central advertising")
